...
const de = {
  ...
  yield: {
    title: "Rendite",
    intro:
      "Gerechnet wird auf der Ebene, auf der gekauft wurde. Ein Kauf trägt oft mehrere Mietverhältnisse — nacheinander bei Mieterwechsel, nebeneinander bei Paketkäufen. Einnahme ist nur, was tatsächlich geflossen ist.",
    ...
    marketRentHint: "Was das Objekt am Markt brächte. Nur nötig, wenn die tatsächliche Miete bewusst darunter liegt.",
    ...
    tenancies: "Zugeordnete Mietverhältnisse",
    noTenancies: "Noch kein Mietverhältnis zugeordnet.",
    assign: "Gehört zu",
    unassigned: "— nicht zugeordnet —",
    unassignedTitle: "Ohne Investition",
    unassignedHint: "Diese Mietverhältnisse gehen in keine Rendite ein.",
    ...
    deleteDetail: "Die zugeordneten Mietverhältnisse bleiben bestehen und verlieren nur die Zuordnung.",
...
const en: Dict = {
  ...
  yield: {
    ...
    marketRentHint: "What the property would fetch on the open market. Only needed where the actual rent is deliberately below it.",
